...
Raphael.fn.ledGauge = function(args) {	
	var paper = this, 
		...
		margin_left = (typeof args.margin.left == 'undefined') ? 
				30 : parseInt(args.margin.left),
		margin_right = (typeof args.margin.right == 'undefined') ? 
				20 : parseInt(args.margin.right),
		margin_top = (typeof args.margin.top == 'undefined') ?
				40 : parseInt(args.margin.top),
		margin_bot = (typeof args.margin.bottom == 'undefined') ?
	...
	var mark_1 = paper.path("M"+startX+","+startY+"h"+(-6)),
		...
		mark_3_value = paper.text(startX-6, 
			(startY-frame.attr("height")), args.min+args.max)
							.attr({
								'text-anchor': 'end',
								'font-size': 14
							});
